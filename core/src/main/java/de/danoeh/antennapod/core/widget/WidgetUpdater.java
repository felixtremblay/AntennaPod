...
public abstract class WidgetUpdater {
    ...
    public static PendingIntent getStartMediaPlayer(Context context, WidgetState widgetState) {
    ...
    public static void setWidgetIcon(Context context, WidgetState widgetState, RemoteViews views) {
        Bitmap icon;
    ...
    public static void setPlayBarStatus(SharedPreferences prefs, int widgetId, RemoteViews views) {
        boolean showRewind = prefs.getBoolean(PlayerWidget.KEY_WIDGET_REWIND + widgetId, false);
        boolean showFastForward = prefs.getBoolean(PlayerWidget.KEY_WIDGET_FAST_FORWARD + widgetId, false);
        boolean showSkip = prefs.getBoolean(PlayerWidget.KEY_WIDGET_SKIP + widgetId, false);
    ...
    public static void setWidgetIds(Context context, RemoteViews views) {
        ...
        for (int id : widgetIds) {
            ...
            setPlayBarStatus(prefs, id, views);
    ...
    public static void setViewContent(Context context, WidgetState widgetState, RemoteViews views) {
    ...
    public static void setProgressString(WidgetState widgetState, RemoteViews views) {
    ...
    public static void updateWidget(Context context, WidgetState widgetState) {
        ...
        PendingIntent startMediaPlayer = getStartMediaPlayer(context, widgetState);
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.player_widget);

        if (widgetState.media != null) {

            setWidgetIcon(context, widgetState, views);
            ...
            setProgressString(widgetState, views);
            setViewContent(context, widgetState, views);
